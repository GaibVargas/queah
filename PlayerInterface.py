...
class PlayerInterface:
  ...
  def fill_main_window(self):
    ...
    self.message = Label(self.message_frame, text="Turno do jogador 1", font="Arial, 15")
  ...
  def changeMessage(self):
    if (self.turn):
      self.message.configure(text="Turno do jogador 1")
    else:
      self.message.configure(text="Turno do jogador 2")
